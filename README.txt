...
animation, model, shape, util, and view, along with the main class EasyAnimator.
...
- *NEW* Builder class - implements AnimationBuilder, a static final class placed within
